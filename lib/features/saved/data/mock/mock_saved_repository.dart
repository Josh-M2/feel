...
class MockSavedRepository {
  ...
  List<SavedHistoryEntry> getHistory() {
    return const <SavedHistoryEntry>[
      SavedHistoryEntry(
        id: 'hist_1',
        kind: SavedHistoryKind.noteWritten,
        title: 'Added a note to Philippians 4:6–7',
        subtitle: 'Prayer before panic',
        timeLabel: 'Today',
      ),
      SavedHistoryEntry(
        id: 'hist_2',
        kind: SavedHistoryKind.highlightSaved,
        title: 'Highlighted Philippians 4:7',
        subtitle: 'shall keep your hearts and minds',
        timeLabel: 'Today',
      ),
      SavedHistoryEntry(
        id: 'hist_3',
        kind: SavedHistoryKind.chapterRead,
      ...
      SavedHistoryEntry(
        id: 'hist_4',
        kind: SavedHistoryKind.bookmarkSaved,
        title: 'Saved Psalm 23:1',
        subtitle: 'The Lord is my shepherd; I shall not want.',
        timeLabel: 'Yesterday',
      ),
      SavedHistoryEntry(
        id: 'hist_5',
        kind: SavedHistoryKind.planOpened,
        title: 'Opened a reading plan',
        subtitle: 'Peace When Anxiety Feels Loud',
        timeLabel: '3 days ago',
      ),
      SavedHistoryEntry(
        id: 'hist_6',
        kind: SavedHistoryKind.verseViewed,
        title: 'Viewed Isaiah 26:3',
        subtitle: 'Perfect peace',
